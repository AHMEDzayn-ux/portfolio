...
export function Hero({ profile }: { profile: Profile }) {
  ...
  const portraitScrollY = useTransform(scrollYProgress, [0, 1], ["0svh", "15svh"]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <motion.div
            ...
            className="absolute inset-0"
          >
            <div className="absolute left-1/2 top-1/2 h-[70vh] w-[85vw] max-h-[760px] max-w-[1400px] -translate-x-[64%] -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse,rgba(96,152,222,0.5),transparent_62%)] blur-2xl" />
            <div className="absolute left-1/2 top-1/2 h-[62vh] w-[75vw] max-h-[680px] max-w-[1300px] -translate-x-[36%] -translate-y-[46%] rounded-full bg-[radial-gradient(ellipse,rgba(236,138,62,0.46),transparent_62%)] blur-2xl" />
          </motion.div>
        </motion.div>
      </motion.div>
      ...
      {/* Text */}
      <motion.div
        style={reduced ? undefined : { y: textScrollY, opacity: textScrollFade }}
      ...
      >
        <motion.span
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-white/25 text-white/60 transition-colors hover:text-brand"
        >
